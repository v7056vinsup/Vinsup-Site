...
import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import "./StudentFormModal.css"; // Imported custom regular CSS file
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            <h2 className="text-white font-bold modal-title">
              Student Pass Registration
            </h2>
            ...
            <form onSubmit={handleSubmit} className="modal-form">
              ...
              <div>
                <label className="text-white label-spacing font-medium">
                  College ID Card
                </label>

                <div className="file-upload-row">
                  <label htmlFor="idCardUpload" className="custom-file-label font-semibold">
                    Upload ID Card
                  </label>

                  <span className="text-gray-300 file-name-text">
                    {form.file ? form.file.name : "No file selected"}
                  </span>
              ...
              <div className="form-actions-row">
                <button
                  type="button"
                  onClick={onClose}
                  className="action-btn cancel-variant text-white"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="action-btn submit-variant text-white font-bold"
                >
