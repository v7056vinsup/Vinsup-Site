...
import { motion } from "framer-motion";
import "./VenueSection.css"; // Imported standard stylesheet
  ...
  return (
    <section className="venue-section">
      <div className="venue-container">
        ...
        >
          {/* Map embed */}
          <div className="map-wrapper race-border glow-red">
            <iframe
              title="Kari Motor Speedway"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3917.8240214385864!2d77.04967657480678!3d10.900975089255489!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba85033fb3ea7d5%3A0x32d9fc805a023de7!2sKari%20Motor%20Speedway%20Racetrack!5e0!3m2!1sen!2sin!4v1782198958875!5m2!1sen!2sin"
              width="100%"
          ...
          <div className="details-column">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="detail-item-card glass-card race-border"
              >
                <span className="detail-icon">{item.icon}</span>
                <div>
                  <p className="font-orbitron detail-label text-gray-500 uppercase">{item.label}</p>
                  <p className="font-rajdhani detail-value text-white">{item.value}</p>
                </div>
              </motion.div>
            ))}
          </div>
